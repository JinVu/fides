...
<html lang="DE">
    <head>
        ...
        <title>Fides Sanctuary @ Light-Shiva</title>
    ...
    Menu
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="gallery.php">Gallerie</a></li>
                        <li class="nav-item"><a class="nav-link" href="https://de.finalfantasyxiv.com/lodestone/freecompany/9232801448574661821/" target="_blank">Lodestone</a></li>
